...
document.write('  <tr>');
document.write('    <td nowrap width="20" height="45" background="../../images/g_header-top.jpg">');
document.write('    <img border="0" src="../../images/g_header-l.jpg" width="200" height="45"></td>');
document.write('    <td width="20%" height="45" background="../../images/g_header-top.jpg">');
...
document.write('    <td nowrap width="75" height="45" background="../../images/g_header-tall.jpg">');
document.write('    <img border="0" src="../../images/g_header-tab.jpg" width="75" height="45"></td>');
document.write('    <td width="100%" height="45" background="../../images/g_header-tall.jpg">');
document.write('    <p align="right">');
document.write('    <font face="Trebuchet MS" size="2" color="#339933"><b>');
...
document.write('  </tr>');
document.write('  <tr>');
document.write('    <td nowrap height="30" background="../../images/g_header-bot.jpg" colspan="3">');
document.write('    <p align="left"><font face="Trebuchet MS" size="2" color="#339933"><b>&nbsp;');
document.write('<a href="../../index.html" style="text-decoration: none">Home</a>|My Spot|<a href="../../forum/index.php" style="text-decoration: none">Forums</a>|<a href="../../journals/list.html" style="text-decoration: none">Journals</a>|<a href="../..//forum/privmsg.php?folder=inbox" style="text-decoration: none">MailSpot</a>|<a href="../../freeformfrog/store.html" style="text-decoration: none">Freeform Frog</font></a></b></font></td>');
document.write('    <td nowrap height="30" background="../../images/g_header-bot.jpg">');
document.write('    <p align="center"><b><font face="Trebuchet MS" color="#339933">What you ');
