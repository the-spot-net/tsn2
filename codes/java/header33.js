...
document.write('  <tr>');
document.write('    <td nowrap width="20" height="45" background="../../images/b_header-top.jpg">');
document.write('    <img border="0" src="../../images/b_header-l.jpg" width="225" height="45"></td>');
document.write('    <td width="20%" height="45" background="../../images/b_header-top.jpg">');
...
document.write('    <td nowrap width="75" height="45" background="../../images/b_header-tall.jpg">');
document.write('    <img border="0" src="../../images/b_header-tab.jpg" width="75" height="45"></td>');
document.write('    <td width="100%" height="45" background="../../images/b_header-tall.jpg">');
...
document.write('  </tr>');
document.write('  <tr>');
document.write('    <td nowrap height="30" background="../../images/b_header-bot.jpg" colspan="3">');
...
document.write('    <td nowrap height="30" background="../../images/b_header-bot.jpg">');
document.write('    <p align="center"><b><font face="Trebuchet MS" color="#003366">What you ');
document.write('    need...to know.</font></b></td>');
document.write('  </tr>');
document.write('  <tr><td width="100%" height="10" background="../../images/b_fade_bar.jpg" colspan="4"></td></tr>');
