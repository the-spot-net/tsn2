...
document.write('  <tr>');
document.write('    <td nowrap width="20" height="45" background="../../images/r_header-top.jpg">');
document.write('    <img border="0" src="../../images/r_header-l.jpg" width="230" height="45"></td>');
document.write('    <td width="20%" height="45" background="../../images/r_header-top.jpg">');
...
document.write('    <td nowrap width="75" height="45" background="../../images/r_header-tall.jpg">');
document.write('    <img border="0" src="../../images/r_header-tab.jpg" width="75" height="45"></td>');
document.write('    <td width="100%" height="45" background="../../images/r_header-tall.jpg">');
document.write('    <p align="right">');
document.write('    <font face="Trebuchet MS" size="2" color="#ffffff"><b>');
...
document.write('  </tr>');
document.write('  <tr>');
document.write('    <td nowrap height="30" background="../../images/r_header-bot.jpg" colspan="3">');
document.write('    <p align="left"><font face="Trebuchet MS" size="2" color="#ffffff"><b>&nbsp;');
...
document.write('    <td nowrap height="30" background="../../images/r_header-bot.jpg">');
document.write('    <p align="center"><b><font face="Trebuchet MS" color="#ffffff">What you ');
