...
$C_DB_PASS = (isset($C_DB_PASS) ? htmlspecialchars(stripslashes($C_DB_PASS)) : C_DB_PASS);
...
<TR>
	<TD ALIGN=CENTER>
		...
		<TR>
			...
			<TD VALIGN=TOP>
				<INPUT TYPE=password NAME="C_DB_PASS" SIZE=11 MAXLENGTH=30 VALUE="<?php echo($C_DB_PASS); ?>">
			</TD>
		</TR>
		<TR><TD>&nbsp;</TD></TR>
		<TR>
