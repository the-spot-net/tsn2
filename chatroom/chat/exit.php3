...
?>
<A HREF="users_popup<?php echo($Ver1); ?>.php3?<?php echo("From=$From&L=$L"); ?>" onClick="users_popup(); return false" TARGET="_blank"><IMG SRC="images/popup.gif" WIDTH=13 HEIGHT=13 ALIGN="MIDDLE" BORDER=0 ALT="<?php echo(L_DETACH); ?>"></A><?php
if ($Ver == "H")
{
	?>
