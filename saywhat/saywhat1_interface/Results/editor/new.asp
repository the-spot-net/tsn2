...
//--></script><!--webbot BOT="GeneratedScript" endspan --><form METHOD="POST" action="new.asp" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1" webbot-action="--WEBBOT-SELF--">

<!--webbot bot="SaveDatabase" suggestedext="asp" s-dataconnection="saywhat1" s-recordsource="Results" u-confirmation-url="confirm.asp" s-form-fields="Name Email Person1 Person2" s-form-dbfields="Name Email Person1 Person2 " b-usedbfieldsforconfirmation="True" u-asp-include-url="../../../_fpclass/fpdbform.inc" startspan --><input TYPE="hidden" NAME="VTI-GROUP" VALUE="0"><!--#include file="../../../_fpclass/fpdbform.inc"--><!--webbot bot="SaveDatabase" endspan i-checksum="52631" -->
